% =========================================================================
% SIMULADOR DE FUERZA BRUTA / MONTECARLO - LIGA IO 2026
% =========================================================================

clear; clc;

% --- 1. CONFIGURACIÓN ---
num_candidatos = 100000; % Número de equipos aleatorios que vamos a evaluar
num_rivales = 30;     % Tamaño de la liga de prueba (sparrings)
partidos_por_rival = 20; % Partidos contra el mismo rival para reducir la "suerte"
...
fprintf('Iniciando simulación de partidos... Esto puede tardar un poco.\n');
...
for i = 1:num_candidatos
    ...
    for j = 1:num_rivales
        ...
        for k = 1:partidos_por_rival
            [GA_vec, GB_vec] = mi_playMatch(equipo_A, equipo_B);
...
% En caso de empate, sortrows usará la diferencia de goles (columna 4) si lo especificamos:
...
% Generando 1000000 equipos candidatos y 20 rivales...
% Iniciando simulación de partidos... Esto puede tardar un poco.

% === RESULTADOS DE LA BÚSQUEDA ===
% MEJOR EQUIPO ENCONTRADO:
% A = [10, 6, 10, 14, 12, 3, 7, 8, 19, 10]
% Puntos: 436 | Goles a Favor: 377 | Goles en Contra: 167 | Diferencia: 210
% Gasto total de presupuesto: 99

% Equipo guardado exitosamente en 01.mat (variable v)